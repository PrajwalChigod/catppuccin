...
If you want to stay on nvim 0.7, pin catppuccin tag to v0.2.4 and nvim-treesitter commit to 4cccb6f494eb255b32a290d37c35ca12584c74d0.
	...
	local colors = { -- Reference: https://github.com/nvim-treesitter/nvim-treesitter/blob/master/CONTRIBUTING.md
		...
		["@constant.builtin"] = {
			fg = U.vary_color({ espresso = C.flamingo }, C.peach),
			style = U.vary_color({ espresso = { "bold" } }, O.styles.keywords or {}),
		...
		["@function.builtin"] = { fg = U.vary_color({ espresso = C.blue }, C.peach), style = O.styles.functions or {} }, -- For builtin functions: table.insert in Lua.
